...
import com.example.abhishek_janga_project2.databinding.CartRowBinding;
...
public class CartAdapter extends ListAdapter<CartItem, CartAdapter.CartVH> {
    ...
    class CartVH extends RecyclerView.ViewHolder {
        ...
        public CartVH(@NonNull CartRowBinding cartRowBinding) {
            ...
            cartRowBinding.qtySpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                @Override
