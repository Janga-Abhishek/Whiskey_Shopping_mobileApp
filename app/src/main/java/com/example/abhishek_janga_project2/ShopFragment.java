...
import com.example.abhishek_janga_project2.adapters.ShopListAdapter;
import com.example.abhishek_janga_project2.databinding.FragmentShopBinding;
...
public class ShopFragment extends Fragment implements ShopListAdapter.ShopInterface {
    ...
    public void addItem(Product product) {
        ...
        if (isAdded) {
            ...
            Snackbar.make(requireView(), "Max Of 5 Products only.", Snackbar.LENGTH_LONG)
                    .show();
        }
    }
